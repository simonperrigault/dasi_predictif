...
public class JPAutil {
    ...
    /**
     * Valide la transaction courante sur l'instance courante du Contexte de Persistance (Entity Manager).<br><strong>À utiliser uniquement au niveau Service.</strong>
     *
